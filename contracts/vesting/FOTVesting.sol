...
contract FOTVesting is ReentrancyGuard, IFOTVesting {
    ...
    modifier onlyNotRevoked(address _beneficiary, uint256 _planID) {
        require(
            ...
            "FOTVesting::Your vesting are revoked"
        );
        _;
    }
    ...
    modifier onlyRevocablePlan(uint256 _planID) {
        require(
            ...
            "FOTVesting:Vesting is not revocable"
        );
        _;
    }
    ...
    function createVestingPlan(
        ...
        require(
            ...
            "FOTVesting::start date is not valid"
        );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "FOTVesting::createVesting:StartDate is not valid"
        );
    ...
    function setDebt(
        ...
        require(
            ...
            "FOTVesting::Debt limit Exceeded"
        );
    ...
    function _getClaimableToken(
        ...
        for (uint256 i = 0; i < vestingList.length; i++) {
            ...
            require(
                ...
                "FOTVesting::Only beneficiary can claim"
            );
